...
namespace LeagueSharp.Common
{
    public static class Interrupter2
    {
        ...
        private static Dictionary<string, List<InterruptableSpell>> InterruptableSpells { get; set; }		+        public static Dictionary<string, List<InterruptableSpell>> InterruptableSpells { get; private set; }
